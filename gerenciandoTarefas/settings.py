...
ALLOWED_HOSTS = ['esgEmerson.pythonanywhere.com', 'localhost', '127.0.0.1']
...
# Diretórios adicionais onde o Django deve procurar por arquivos estáticos (sua pasta 'static')
STATICFILES_DIRS = [
