...
class FerramentaAdmin(FilialAdminMixin, admin.ModelAdmin):
...
class MovimentacaoAdmin(FilialAdminMixin, admin.ModelAdmin):
...
class AtividadeAdmin(FilialAdminMixin, admin.ModelAdmin):
