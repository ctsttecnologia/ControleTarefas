    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fornecedor_padrao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='seguranca_trabalho.fornecedor', verbose_name='Fornecedor Padrão')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funcao', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='seguranca_trabalho.funcao', verbose_name='Função na Admissão')),
            ],
            options={
