...
urlpatterns = [
    ...
    # ── Locais de Prestacao de Servico ──
    ...
    # ── AJAX: Profissionais Responsaveis ──
    ...
    path("ajax/cargo-info/", views.ajax_cargo_info, name="ajax_cargo_info"),
    path("ajax/funcao-st-info/", views.ajax_funcao_st_info, name="ajax_funcao_st_info"),
