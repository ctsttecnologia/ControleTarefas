# Generated by Django 5.2 on 2025-12-01 01:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tarefa', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chat_rooms', to='tarefas.tarefas', verbose_name='Tarefa Relacionada')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['room', 'search_text'], name='chat_chatse_room_id_2f35fd_idx'),
        ),
        migrations.AddIndex(
