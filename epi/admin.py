...
from .models import EPI, FichaEPI, ItemEPI, EquipamentoSeguranca
...
@admin.register(EquipamentoSeguranca)
class EquipamentoSegurancaAdmin(admin.ModelAdmin):
    list_display = ('nome_equipamento', 'tipo', 'codigo_CA', 'ativo')
    list_filter = ('tipo', 'ativo')
    search_fields = ('nome_equipamento', 'codigo_CA')